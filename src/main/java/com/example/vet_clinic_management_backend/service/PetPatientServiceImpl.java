...
@Service
public class PetPatientServiceImpl implements PetPatientService{
    ...
    public String createPetPatient(PetPatient petPatient) {
        try {
    ...
    public String updatePetPatient(String documentId, PetPatient petPatient) {
        try {
    ...
    public String deletePetPatient(String documentId) {
        try {
            ApiFuture<DocumentSnapshot> documentSnapshotApiFuture = petPatientRepository.findPetPatientById(documentId);
            DocumentSnapshot documentSnapshot = documentSnapshotApiFuture.get();
